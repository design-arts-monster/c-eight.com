 ...
 * 画像一括変換スクリプト
 *
 * @see https://qiita.com/bananacoffee/items/1f36854d6fbc0b6e809a
...
program
  ...
  .option('-a, --webp-suffix-add', 'webp化を行った際の拡張子の処理（true:拡張子の後ろに追加、false:既存の拡張子を置換）', false)
...
let ts_worker_end
const targetFileNum = imageFileList.length
